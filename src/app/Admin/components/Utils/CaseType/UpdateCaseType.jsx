...
import { FaGavel, FaTimes, FaSave, FaAlignRight } from "react-icons/fa";
    ...
    >
      ...
      >
        ...
        <Formik
          ...
          onSubmit={(values) => {
            handleUpdateCaseTypeFun({ id: selectCaseType._id, values });
          }}
        >
          {({ isSubmitting }) => (
            <Form>
              <div className="px-6 py-6 space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <FaGavel className="absolute text-sm -translate-y-1/2 right-4 top-1/2 text-slate-400" />
