...
const AddCase = () => {
  ...
  const isOfficeOwner = profile?.user?.role === "office_owner";

  const initialValues = {
    clientId: "",
    lawyers: profile?.user?._id
      ? [profile.user._id]
      : [],
    caseNumber: "",
    court: "",
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="flex add-case-scrollbar max-h-[92vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl border border-slate-700 bg-slate-900 shadow-2xl">
