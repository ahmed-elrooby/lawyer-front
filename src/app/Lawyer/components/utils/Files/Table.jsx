...
const Table = () => {
  ...
  const filteredDocuments = useMemo(() => {
    ...
    return attachments.filter((document) => {
      const documentName =
      ...
      const uploaderEmail =
        document?.uploadedBy?.email?.toLowerCase() || "";
      ...
      return (
        ...
        mimeType.includes(value) ||
        uploaderName.includes(value) ||
        uploaderEmail.includes(value)
      );
    });
  }, [attachments, search]);
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 p-4 sm:p-6">
          ...
          <div
            className="flex flex-col gap-4 mb-6 lg:flex-row lg:items-center lg:justify-between"
          >
            {/* Title */}
            <div>
              ...
              <p className="mt-1 text-sm text-slate-400">
                إدارة جميع المستندات والملفات الخاصة بالمكتب
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <div className="relative w-full sm:w-80">
                <Search
                  className="absolute w-4 h-4 -translate-y-1/2 right-3 top-1/2 text-slate-500"
                />
              ...
              {/* View Toggle */}
              <div
                className="flex items-center p-1 border rounded-xl border-slate-700 bg-slate-800/70"
              >
                <button
                  type="button"
                  onClick={() =>
          ...
          {filteredDocuments.length === 0 && (
            ...
            >
              <div
                className="flex items-center justify-center w-16 h-16 mb-4 rounded-2xl bg-slate-800"
              >
                <FileText
            ...
            viewMode === "table" && (
              <div className="w-full overflow-x-auto border rounded-2xl border-slate-700/60">
                ...
                >
                  <thead>
                    <tr
                      className="border-b border-slate-700/60 bg-slate-800/70"
                    >
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <div className="mt-5">
                            ...
                            <p
                              className="text-xs truncate text-slate-300"
                              title={
                                document?.originalName
                              }
                            >
                          ...
                          {/* Uploaded By */}
                          <div className="flex items-center justify-between gap-3 pt-4 mt-4 border-t border-slate-700/60">
                            <div className="flex items-center gap-2 ">
                              <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-700/50">
                                <User
                          ...
                          {/* Actions */}
                          <div className="flex items-center justify-end gap-1 pt-4 mt-4 border-t border-slate-700/60">
                            {/* Details */}
                            <button
                              type="button"
                              onClick={() =>
