...
const AddSession = () => {
  ...
  const validationSchema = Yup.object({
    ...
    decision: Yup.string()
      .max(2000, "القرار يجب ألا يتجاوز 2000 حرف"),
  ...
  const handleSubmit = async (values, { resetForm }) => {
    await handleAddSessionFun(values);
    resetForm();
  };
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Field
                        ...
                        className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pr-10 pl-3 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-[#c9a227] focus:bg-white"
                      />
                    </div>
