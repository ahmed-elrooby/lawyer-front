        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-[11px] text-[#45464D] sm:text-xs">
              توزيع مهمة على أحد محامي المكتب
            </p>
          </div>
        </div>
        ...
        <Form className="p-4 space-y-4 sm:p-6 sm:space-y-5">
          ...
          <div className="flex items-center justify-end gap-3 pt-3 border-t border-[#E7EBF2]">
            <button
              type="button"
              onClick={() => setOpenAddTask(false)}
              className="px-4 py-2.5 text-sm font-semibold transition rounded-lg border border-[#E7EBF2] text-[#45464D] bg-white hover:bg-[#F8F9FB] sm:px-5"
            >
              إلغاء
            </button>
            ...
            >
              {loadding ? "جاري إضافة المهمة" : "إضافة المهمة"}
            </button>
          </div>
        </Form>
      </Formik>
